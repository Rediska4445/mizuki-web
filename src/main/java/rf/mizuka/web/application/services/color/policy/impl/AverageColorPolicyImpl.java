package rf.mizuka.web.application.services.color.policy.impl;
...
/* Class implemented color policy took from mizuki-player */
public final class AverageColorPolicyImpl
        implements ColorPolicy
{
    @Override
